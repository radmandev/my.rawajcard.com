...
export const PREMADE_TEMPLATES = [
 ...
 textColor:'#fff9e8',
 chipClass:'bg-indigo-950/60/25 text-white border-white/40',
 },
 {
 id:'silver-metal',
 nameEn:'Silver Metal',
 ...
 textColor:'#fff8f0',
 chipClass:'bg-indigo-950/60/20 text-white border-white/30',
 },
 {
 id:'dark-wood',
 nameEn:'Dark Wood',
...
export function PhysicalCardPreview({ template, name, signature, picture, qrDataUrl, isRTL }) {
 ...
 <div className="h-14 w-14 rounded-full border-2 border-white/40 bg-indigo-950/60/10 flex items-center justify-center text-xs opacity-70">
 {isRTL ?'صورة' :'Photo'}
 </div>
 )}
 </div>
 ...
 <div className="h-16 w-16 rounded-md bg-indigo-950/60 p-1.5 flex items-center justify-center shadow-sm">
 {qrDataUrl ? (
