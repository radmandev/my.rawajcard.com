...
export default function CartSidebar({ isOpen, onClose, items, onUpdateQuantity, onRemove }) {
 ...
 <p className="text-slate-500 mb-4">{t('emptyCart')}</p>
 ...
 >
 {/* Image */}
 <div className="h-20 w-20 rounded-lg overflow-hidden bg-slate-200 flex-shrink-0">
 {item.product_image ? (
 <img 
 ...
 onClick={() => {
 void trackWebsiteEvent('checkout_cta_click', {
 pageName:'Cart Sidebar',
 metadata: buildCartTrackingData(items),
 });
 onClose();
 }}
 >
