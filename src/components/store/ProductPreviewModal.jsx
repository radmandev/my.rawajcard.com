...
export default function ProductPreviewModal({ product, onClose }) {
 ...
 addItem(product, { pageName:'Store', source:'product_preview_modal_buy_now', flow:'buy_now' });
 onClose();
 ...
 {/* Image panel */}
 <div
 className="relative bg-slate-100 aspect-square md:aspect-auto md:min-h-[400px] cursor-pointer"
 ...
 <div className="w-full h-full flex items-center justify-center text-7xl font-bold text-slate-300">
 {name?.charAt(0)}
 </div>
 )}
 {discountPct > 0 && (
