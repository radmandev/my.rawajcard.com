...
export default function VisualCanvas({
 ...
 <div
 className="relative shadow-2xl rounded-3xl overflow-hidden bg-indigo-950/60"
 style={{
 width: canvasWidth,
 minHeight: 700,
 ...
 selectedElement === element.id ?'ring-2 ring-cyan-500' :''
 }`}
 ...
 >
 {/* Element Controls */}
 <div className="absolute -top-8 right-0 opacity-0 group-hover:opacity-100 transition-opacity z-10 flex gap-1 bg-indigo-950/60 rounded-lg shadow-lg p-1">
 <button
 ...
 <div className="absolute bottom-4 right-4 bg-indigo-950/60 px-3 py-1 rounded-full text-xs opacity-50">
