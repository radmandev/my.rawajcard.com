...
export default function PropertyEditor({
 ...
 if (!selectedElement) {
 return (
 <div className="w-80 bg-indigo-950/60 border-l border-slate-200 flex flex-col">
 ...
 className="group relative h-12 rounded-lg overflow-hidden border-2 hover:border-cyan-500 transition-all"
 title={preset.name}
 >
