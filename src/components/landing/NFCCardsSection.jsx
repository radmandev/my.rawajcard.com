...
export default function NFCCardsSection() {
 ...
 return (
 <section className="py-20 bg-gradient-to-br from-cyan-900 via-slate-900 to-blue-900 relative overflow-hidden">
 {/* Background decoration */}
 <div className="absolute inset-0 opacity-20">
 <div className="absolute top-1/4 left-0 w-72 h-72 bg-cyan-400 rounded-full blur-3xl" />
 ...
 <div className="bg-indigo-950/60/5 backdrop-blur-sm rounded-2xl p-8 h-full border border-white/10 hover:border-white/20 transition-all duration-300 hover:bg-indigo-950/60/10">
 {/* Image */}
