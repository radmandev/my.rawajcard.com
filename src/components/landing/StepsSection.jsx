...
export default function StepsSection() {
 ...
 <span className="text-cyan-600 text-sm font-semibold tracking-wider uppercase">{t.subtitle}</span>
 </div>
 ...
 <span className="inline-flex items-center px-3 py-1 bg-slate-100 text-slate-500 text-xs font-medium rounded-full">
 {t.stepLabel} {item.step}
 </span>
 </div>
 
 <div className="bg-slate-50 rounded-2xl p-6 pt-8 h-full hover:shadow-xl transition-all duration-300 border border-slate-100 group-hover:border-slate-200">
 {/* Icon */}
 ...
 <div className="w-full aspect-[3/4] bg-indigo-950/60 rounded-xl shadow-inner overflow-hidden border border-slate-100">
