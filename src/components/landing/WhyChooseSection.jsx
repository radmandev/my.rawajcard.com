...
export default function WhyChooseSection() {
 ...
 <div className="flex-shrink-0 w-10 h-10 rounded-xl bg-gradient-to-br from-cyan-50 to-blue-50 flex items-center justify-center group-hover:from-cyan-100 group-hover:to-blue-100 transition-colors">
 ...
 {/* Dashboard mockup */}
 <div className="aspect-[4/3] bg-indigo-950/60 rounded-xl overflow-hidden">
 ...
 <div className="h-6 w-16 bg-cyan-100 rounded-full" />
 </div>
 ))}
 </div>
 </div>
