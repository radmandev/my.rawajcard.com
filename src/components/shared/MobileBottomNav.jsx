...
export default function MobileBottomNav() {
 ...
 return (
 <nav 
 className="fixed bottom-0 left-0 right-0 z-50 bg-indigo-950/60 border-t border-slate-200 md:hidden"
...
"user-select-none -webkit-user-select-none",
 ...
 className="flex flex-col items-center gap-1 py-3 px-4 flex-1 transition-colors text-red-500"
 >
