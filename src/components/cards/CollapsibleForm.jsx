...
export default function CollapsibleForm({ card, onChange }) {
 ...
 {translating.name_ar && <Loader2 className="h-3 w-3 animate-spin text-cyan-600" />}
 </div>
 <Input
 value={card.name_ar ||''}
 ...
 {translating.title_ar && <Loader2 className="h-3 w-3 animate-spin text-cyan-600" />}
 </div>
 <Input
 value={card.title_ar ||''}
 ...
 <div className="flex items-center gap-2">
 <Label>{t('bioAr')}</Label>
 {translating.bio_ar && <Loader2 className="h-3 w-3 animate-spin text-cyan-600" />}
 </div>
 <Textarea
 value={card.bio_ar ||''}
 ...
 {translating.company_ar && <Loader2 className="h-3 w-3 animate-spin text-cyan-600" />}
 </div>
 <Input
 ...
 {translating.location_ar && <Loader2 className="h-3 w-3 animate-spin text-cyan-600" />}
 </div>
 <Input
 ...
 className="flex rounded-lg overflow-hidden border-2 border-slate-200 hover:border-cyan-400 transition-colors"
 >
