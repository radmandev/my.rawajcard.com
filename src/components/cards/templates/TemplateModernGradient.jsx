...
export default function TemplateModernGradient({ card, isRTL, onLinkClick }) {
 ...
 <div className="bg-indigo-950/60/80 backdrop-blur-xl rounded-3xl p-6 mb-6 shadow-xl border border-white/20">
 ...
 target="_blank"
 rel="noopener noreferrer"
 className="w-12 h-12 rounded-full bg-indigo-950/60/80 backdrop-blur-xl flex items-center justify-center shadow-lg hover:shadow-xl transition-all hover:scale-110 border border-white/20"
 >
