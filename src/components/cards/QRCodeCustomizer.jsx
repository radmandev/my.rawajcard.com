...
'flex-shrink-0 w-[72px] rounded-xl border-2 p-1.5 transition-all',
 ...
 <p className="text-[10px] text-center mt-1 font-medium truncate text-slate-600">
 ...
 {qrSettings?.logo_url ? (
 <div className="space-y-2">
 <div className="relative w-20 h-20 rounded-lg border-2 border-slate-200 overflow-hidden">
 <img
 ...
 <label className="flex items-center justify-center gap-2 p-4 border-2 border-dashed border-slate-300 rounded-lg cursor-pointer hover:bg-slate-50 transition-colors">
