...
"p-2 rounded-md transition-colors",
 viewMode ==='grid' 
 ?"bg-indigo-950/60 shadow-sm" 
 :"hover:bg-indigo-950/60/50"
 )}
 >
...
"relative rounded-xl overflow-hidden border-2 transition-all hover:shadow-lg",
 ...
 className="absolute top-2 right-2 h-8 w-8 rounded-full bg-indigo-950/60/90 flex items-center justify-center text-slate-600 hover:bg-indigo-950/60 transition-colors"
 >
 ...
 {/* Selected Badge */}
 {selectedTemplate === template.id && (
 <div className="absolute top-2 left-2 h-6 w-6 rounded-full bg-cyan-500 flex items-center justify-center text-white">
 ...
 <div className="h-16 w-16 rounded-full bg-indigo-950/60/20 backdrop-blur-sm flex items-center justify-center">
 ...
 {/* Info */}
 <div className="p-3 bg-indigo-950/60">
