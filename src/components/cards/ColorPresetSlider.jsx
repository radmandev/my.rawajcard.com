...
export default function ColorPresetSlider({ onSelectPreset, isRTL }) {
 ...
 className="group relative flex flex-col items-center gap-1 p-2 rounded-lg hover:bg-slate-100 transition-colors"
 title={preset.name}
 >
 <div className="flex rounded-lg overflow-hidden border-2 border-slate-200 group-hover:border-cyan-400 transition-colors">
