...
export default function AdminOrders() {
 ...
 <button onClick={() => refetch()} className="text-sm text-cyan-600 hover:underline">
 ...
 {/* Amount */}
 <td className="px-4 py-3">
 <span className="font-bold text-cyan-600 whitespace-nowrap">
...
function OrderDetailDialog({ order, onClose, onUpdateStatus, isUpdating, isRTL }) {
 ...
 <div className="flex items-center gap-2">
 <TrendingUp className="h-4 w-4 flex-shrink-0 text-cyan-500" />
 ...
 <span className="font-bold text-cyan-600 whitespace-nowrap text-sm">
