...
function ExportButton({ label, onClick }) {
 ...
 <button
 onClick={onClick}
 className="flex items-center gap-2 px-3 py-2 text-xs font-semibold text-cyan-700 bg-cyan-50 hover:bg-cyan-100 rounded-xl transition-colors border border-cyan-200"
 >
