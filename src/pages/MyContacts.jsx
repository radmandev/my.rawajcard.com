...
export default function MyContacts() {
 ...
 >
 <div className="bg-cyan-600 text-white px-4 py-2 rounded-full shadow-lg">
 {isRefreshing ? (
 ...
 <div className="flex items-center justify-between">
 <div>
 <p className="text-cyan-100 text-sm">{isRTL ?'بطاقات نشطة' :'Active Cards'}</p>
 <p className="text-3xl font-bold mt-1">{cards.filter(c => c.status ==='published').length}</p>
 </div>
 <Building2 className="h-12 w-12 text-cyan-100" />
 </div>
 </CardContent>
 </Card>
 </div>
 ...
 <div className="h-12 w-12 rounded-full bg-gradient-to-br from-cyan-500 to-magenta-600 flex items-center justify-center text-white font-bold flex-shrink-0">
