...
export default function Dashboard() {
 ...
 const shouldOpenPricing = params.get('openPricing') ==='1';

 if (!shouldOpenPricing) return;
 ...
 }, [location.pathname, location.search, navigate, openUpgradeDialog]);
 ...
 const quickActions = [
 { key:'create', icon: Plus, label: t('createCard'), path: createPageUrl('CardBuilder'), color:'from-cyan-500 to-cyan-600' },
