...
const PAYMENT_METHODS = [
 ...
 label:'Card',
 labelAr:'بطاقة',
 color:'border-cyan-500 bg-cyan-100/20',
 },
 {
 id:'bank_transfer',
 label:'Bank',
...
export default function Checkout() {
 ...
 const cartTrackingData = useMemo(() => buildCartTrackingData(cartItems), [cartItems]);

 useEffect(() => {
 void trackWebsiteEvent('begin_checkout', {
 pageName:'Checkout',
 path:'/Checkout',
 userId: user?.id || null,
 ...
 await trackWebsiteEvent('checkout_submit', {
 pageName:'Checkout',
 path:'/Checkout',
 userId: user?.id || null,
 userEmail: user?.email || finalShippingInfo.email || null,
 metadata: {
 ...cartTrackingData,
 payment_method: paymentMethod,
 shipping_city: finalShippingInfo.city,
 shipping_cost: shippingCost,
 total,
 },
 });
...
'w-4 h-4 rounded-full border flex items-center justify-center flex-shrink-0 transition-colors',
 ...
 <div className="h-6 w-9 bg-indigo-950/60 border border-slate-200 rounded flex items-center justify-center overflow-hidden">
 ...
 className="p-1.5 rounded-lg hover:bg-indigo-900 text-slate-400 hover:text-cyan-400 transition-colors flex-shrink-0"
 ...
 <div className="flex items-center gap-3 p-4 bg-indigo-950/60">
 ...
 className="p-1.5 bg-cyan-600 text-white rounded-full shadow hover:bg-cyan-700 transition-colors"
 ...
 <div className="px-3 py-2 bg-green-100 flex items-center gap-1.5">
 ...
 type="button"
 onClick={() => receiptRef.current?.click()}
 className="w-full h-32 rounded-xl border-2 border-dashed border-green-300 flex flex-col items-center justify-center gap-2 hover:border-green-500 hover:bg-green-50 transition-all"
 >
 ...
 {/* Order Summary */}
 <div>
 <Card className="bg-indigo-950/60 border-slate-200/50 sticky top-24">
 <CardHeader>
