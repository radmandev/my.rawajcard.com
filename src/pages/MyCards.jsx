...
export default function MyCards() {
 ...
 >
 <Card className={cn(
"overflow-hidden bg-indigo-950/60",
"border-slate-200/50",
...
"absolute top-3 left-3 z-10",
 ...
 {card.company_logo && (
 <div 
 className="absolute top-0 left-5 h-10 w-10 rounded-lg overflow-hidden border-2 border-white bg-indigo-950/60"
 >
 ...
 <div className="h-20 w-20 rounded-full overflow-hidden border-4 border-white bg-slate-200">
 {card.profile_image ? (
 <img 
 ...
 <div className="h-full w-full flex items-center justify-center bg-gradient-to-br from-cyan-500 to-magenta-600 text-white text-xl font-bold">
 ...
 {/* Bio Preview */}
 {card.bio && (
 <p className="text-xs text-slate-600 text-center mt-3 line-clamp-2">
 ...
 <div className="px-3 pb-3 pt-4 border-t border-slate-100 mt-4">
