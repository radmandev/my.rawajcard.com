...
"w-8 md:w-16 h-0.5 mx-2",
 ...
 <span className="font-mono text-cyan-600">rawajcard.com/c/{card.slug}</span>
 </div>
 <div className="flex justify-between">
 ...
 className="w-full bg-gradient-to-r from-cyan-600 to-magenta-600 hover:from-cyan-700 hover:to-magenta-700"
 size="lg"
 >
