...
export default function TemplateAnalytics() {
 ...
 <div className="flex items-center justify-between">
 <div>
 <p className="text-sm text-slate-500">{isRTL ?'النقرات' :'Total Clicks'}</p>
 ...
 <div className="flex items-center justify-between">
 <div>
 <p className="text-sm text-slate-500">{isRTL ?'التحويلات' :'Conversions'}</p>
 <p className="text-2xl font-bold text-slate-900 mt-1">{totalSubmissions.toLocaleString()}</p>
 </div>
 ...
 <div className="flex items-center justify-between">
 <div>
 <p className="text-sm text-slate-500">{isRTL ?'معدل النقر' :'Avg CTR'}</p>
 <p className="text-2xl font-bold text-slate-900 mt-1">{avgCTR}%</p>
 </div>
 ...
 <div className="flex items-center justify-between">
 <div>
 <p className="text-sm text-slate-500">{isRTL ?'معدل التحويل' :'Conversion Rate'}</p>
 <p className="text-2xl font-bold text-slate-900 mt-1">{avgConversion}%</p>
 </div>
 ...
 <div key={template.template} className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
 ...
 <p className="font-bold text-cyan-600">{template.views.toLocaleString()}</p>
 ...
 <tr key={template.template} className="border-b border-slate-100 hover:bg-slate-50">
 <td className="p-3">
 ...
 <span className="font-bold text-cyan-600">{item.value.toLocaleString()}</span>
 </div>
 ))}
 </div>
 </CardContent>
 ...
 <p className="text-lg font-bold text-cyan-700 capitalize">
