...
export default function Upgrade() {
 ...
 >
 <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-cyan-100 text-cyan-700 text-sm font-medium mb-2">
...
'relative rounded-2xl border p-6 flex flex-col gap-5 transition-all',
 isPopular
 ?'border-cyan-500 ring-2 ring-cyan-500/30 shadow-xl shadow-cyan-500/10 bg-gradient-to-b from-cyan-50/60 to-white'
 ...
 <Badge className="bg-cyan-600 text-white px-4 shadow-md">
 ...
 <Badge variant="outline" className="border-slate-400 bg-indigo-950/60 text-xs">
...
'w-full h-11 font-semibold text-white',
 plan.key ==='premium' &&'bg-cyan-600 hover:bg-cyan-700',
 plan.key ==='teams' &&'bg-cyan-700 hover:bg-cyan-800',
