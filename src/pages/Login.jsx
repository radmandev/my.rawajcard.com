...
'focus:border-cyan-500 focus:ring-2 focus:ring-cyan-500/20';
 ...
 <Link
 to="/"
 className="fixed top-4 left-4 flex items-center gap-1.5 px-3 py-2 text-sm font-medium text-slate-600 hover:text-cyan-600 bg-indigo-950/60 border border-slate-200 rounded-xl shadow-sm transition-all"
 >
 ...
 <div className="bg-indigo-950/60 rounded-3xl shadow-xl border border-slate-200/60 p-8 space-y-6">

 {/* Logo + Title */}
 <div className="text-center space-y-3">
 <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-cyan-500 to-fuchsia-500 shadow-lg mx-auto p-1">
 ...
 className="w-full py-3 rounded-xl bg-slate-900 text-white text-sm font-semibold hover:bg-slate-700 transition-all disabled:opacity-60 disabled:cursor-not-allowed shadow-sm"
 >
 {isSubmitting
 ?'Please wait...'
 : forgotMode
